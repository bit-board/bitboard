...
// this line is causing some problem
    ...
    printf("HIDServiceBase::end of HIDServiceBase initialization\r\n");
}

void HIDServiceBase::startReportTicker(void) {
    printf("HIDServiceBase::startReportTicker\r\n");
...
void HIDServiceBase::stopReportTicker(void) {
    printf("HIDServiceBase::stopReportTicker\r\n");
    reportTicker.detach();
    reportTickerIsActive = false;
}

void HIDServiceBase::onDataSent(unsigned count) {
    printf("HIDServiceBase::onDataSent\r\n");
    startReportTicker();
}

GattAttribute** HIDServiceBase::inputReportDescriptors() {
    printf("HIDServiceBase::inputReportDescriptors\r\n");
...
GattAttribute** HIDServiceBase::outputReportDescriptors() {
    printf("HIDServiceBase::outputReportDescriptors\r\n");
...
GattAttribute** HIDServiceBase::featureReportDescriptors() {
    printf("HIDServiceBase::featureReportDescriptors\r\n");
