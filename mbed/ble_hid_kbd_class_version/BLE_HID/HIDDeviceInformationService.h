...
public:
    ...
    HIDDeviceInformationService(BLE            &_ble,
        ...
        pnpIDCharacteristic(GattCharacteristic::UUID_PNP_ID_CHAR,
                            PnPID)
    {
        printf("HIDDeviceInformationService::HIDDeviceInformationService 1\r\n");
        static bool serviceAdded = false; /* We should only ever need to add the heart rate service once. */
        if (serviceAdded) {
            return;
        }
        printf("HIDDeviceInformationService::HIDDeviceInformationService 2\r\n");
        GattCharacteristic *charTable[] = {&manufacturersNameStringCharacteristic,
                                           ...
                                           &pnpIDCharacteristic};
        printf("HIDDeviceInformationService::HIDDeviceInformationService 3\r\n");
//        GattService         deviceInformationService(GattService::UUID_DEVICE_INFORMATION_SERVICE, charTable,
        GattService         deviceInformationService(GattService::UUID_HUMAN_INTERFACE_DEVICE_SERVICE, charTable,
                                                     sizeof(charTable) / sizeof(GattCharacteristic *));
        printf("HIDDeviceInformationService::HIDDeviceInformationService 4\r\n");
        /*
         ...
         */
        printf("HIDDeviceInformationService::HIDDeviceInformationService 5\r\n");
        pnpIDCharacteristic.requireSecurity(SecurityManager::SECURITY_MODE_ENCRYPTION_NO_MITM);
        printf("HIDDeviceInformationService::HIDDeviceInformationService 6\r\n");
        ble.gattServer().addService(deviceInformationService);
        printf("HIDDeviceInformationService::HIDDeviceInformationService 7\r\n");
        serviceAdded = true;
    }
